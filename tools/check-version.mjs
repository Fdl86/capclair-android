...
const expectedArtifact = `cap-clair-dev${major}-${minor}-${patch}-debug-apk`;
...
if (!workflow.includes(`name: ${expectedArtifact}`)) failures.push(`workflow artifact must be ${expectedArtifact}`);
